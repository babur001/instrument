...
function SvgLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 25 34" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="0.242249" width="14.8579" height="33.6393" rx="1.86885" fill="#30A8F7" />
      ...
      <defs>
        <filter id="filter0_b" x="-364.829" y="-369.016" width="763.28" height="771.048" filterUnits="userSpaceOnUse">
