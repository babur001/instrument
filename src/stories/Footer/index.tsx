...
function Footer() {
  return (
    <footer className="rounded-t-[15px] shadow-200 | px-5 py-5">
      <div className="container mx-auto grid grid-cols-4 gap-10">
        <div>
          ...
          <div className="flex items-center | pt-5">
            ...
            <div className="flex flex-col pl-3">
              <a className="hover:text-[#30A8F7] duration-200 text-sm" href="tel:+998907271449">
                +998 90 727 14-49
              </a>
              <a className="hover:text-[#30A8F7] duration-200 text-sm" href="tel:+998907271449">
                +998 90 727 14-49
            ...
            <div className="">
              <svg className="w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  strokeLinejoin="round"
                />
                <path d="M16.0315 14.3996L11.999 11.9939V6.80786" stroke="black" strokeWidth="0.891892" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
        ...
        <div className="pt-5">
          ...
          <div className="flex flex-col pt-2">
            <a href="#" className="hover:text-[#30A8F7] duration-200 text-sm pt-2">
              Возврат товара
            </a>
            <a href="#" className="hover:text-[#30A8F7] duration-200 text-sm pt-2">
              Доставка
