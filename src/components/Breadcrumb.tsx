  ...
  return (
    <div className="pt-7 flex items-center">
      <div className="flex items-center">
        <Link href="#">
          <p className="hover:text-[#30A8F7] duration-200 text-[#001A34] text-sm">Электроника</p>
        </Link>
      </div>

      <svg className="w-1.5 mx-3" viewBox="0 0 5 10" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <div className="flex items-center">
        <Link href="#">
          <p className="hover:text-[#30A8F7] duration-200 text-[#001A34] text-sm">Ноутбуки, планшеты и компьютеры</p>
        </Link>
      </div>
